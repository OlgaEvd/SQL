...
SELECT * FROM staff
ORDER BY salary ASC; -- ASC - исходный параметр от меньшего к большему 

SELECT * FROM staff
ORDER BY salary DESC; -- DESC - параметр от большего к меньшему
...
SELECT post "Должность",
SUM(salary) "Сумма зарплат по должности"
FROM staff
GROUP BY post;

-- 4. Найдите кол-во сотрудников с специальностью (post) «Рабочий» в возрасте от 24 до 49 лет включительно.
SELECT post "Специальность", COUNT(*)  "Кол-во сотрудников"
FROM staff
